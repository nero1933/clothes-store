...
USER_CONFIRMATION_FLAG_TEMPLATE = os.environ.get('USER_CONFIRMATION_FLAG_TEMPLATE')
USER_CONFIRMATION_TIMEOUT = os.environ.get('USER_CONFIRMATION_TIMEOUT')

RESET_PASSWORD_KEY_TEMPLATE = os.environ.get('RESET_PASSWORD_KEY_TEMPLATE')
RESET_PASSWORD_FLAG_TEMPLATE = os.environ.get('RESET_PASSWORD_FLAG_TEMPLATE')
RESET_PASSWORD_TIMEOUT = os.environ.get('RESET_PASSWORD_TIMEOUT')
